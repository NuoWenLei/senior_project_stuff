...
class Part_A(tf.keras.models.Model):
	...
	def call(self, inputs):
		...
		# Embeds shape: (batch_size, feature_size, seq_length, d_model)
		...
		new_sim_embeds = self.concat_inputs_and_apply_dense_layer([lin_proj_self_attention, expanded_weights, expanded_weight_gradients, expanded_biases, expanded_bias_gradients, embed_magnitudes])
